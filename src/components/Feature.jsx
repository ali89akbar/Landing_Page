...
const Feature = () => {
  return (
    <div className='my-24 md:px-14 px-4 max-w-screen-2xl mx-auto ' id='feature'>
       ...
       <p className='text-base text-tertiary'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae reiciendis dolorum vitae quos?</p>
        
        </motion.div>

        <motion.div
          variants={fadeIn("up", 0.6)} // Use the fadeIn function here
          initial="hidden"
          whileInView="show" // Use "animate" instead of "whileInView"
         ...
         className='w-full lg:w-3/4  '>
           ...
           <div className='bg-[rgba(255,255,255,0.04)] rounded-[35px] h-96 shadow-3xl p-8 items-center flex justify-center items-center hover:-translate-y-4 transition-all duration-300 cursor-pointer'>
                <div>
                    ...
                    mt-5 '>Convendient study schedule</h5>
                </div>
            </div>
